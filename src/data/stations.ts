...
export const stations: Station[] = [
  ...
  },
  {
    ...
    hostName: "Bernard \"The Golden Boy\" McMorris",
    genre: "Blues 24/7",
    tagline: "Pure Blues",
    description: "Hosted by Bernard \"The Golden Boy\" McMorris, this station delivers signature blues style and fire from the heart of the blues scene 24/7. Follow at facebook.com/bernard.goldenboy.",
